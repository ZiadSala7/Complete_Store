...
import 'package:complete_store/core/services/graphql/graphql_queries/auth/auth_queries.dart';
import 'package:complete_store/features/auth/models/login/login_request_body.dart';
...
class AuthDataSource {
  ...
  Future<void> addUserIdFirebase({required String userId}) async {
    await FirebaseFirestore.instance.collection('').doc(userId).set({});
  }
}
